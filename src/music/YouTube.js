...
class YouTube {
    ...
    static getYtDlpOptions(extraOptions = {}) {
        const baseOptions = {
            ...
            ffmpegLocation: config.ytdl.ffmpegLocation,
            addHeader: [
                'referer:youtube.com',
        ...
        if (config.ytdl.poToken) {
            ...
            // Auth yapılandırılmamışsa client rotasyonu kullan.
            // YouTube, tek bir client (özellikle ios) için tüm formatları dönmeyebilir;
            // yt-dlp, istenen formatı sağlayan ilk client'ı seçene kadar sırayla dener.
            baseOptions.extractorArgs = 'youtube:player_client=tv,ios,web_safari,mweb,web_embedded';
        }
